...
from keras.layers import Layer, Concatenate, Flatten
...
#Since only 10 percent of the sentences > 712 words, we should be safe using MAX_BODY_LEN as 70
...
#Since only 10 percent of the sentences > 742 words, we should be safe using MAX_BODY_LEN as 750
...
#Since only 15 percent of the sentences > 705 words, we should be safe using MAX_BODY_LEN as 750
